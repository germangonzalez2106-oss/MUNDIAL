...
<div class="container">
    ...
    <div class="charts">
        <div class="chart-box"><h3>⭐ Rating Promedio</h3><canvas id="ratingChart" width="400" height="250"></canvas></div>
        <div class="chart-box"><h3>⚽ Goles Totales</h3><canvas id="golesChart" width="400" height="250"></canvas></div>
    </div>
...
<script>
    ...
    function cargarGraficos() {
        ...
        fetch('/api/selecciones')
            ...
            .then(data => {
                ...
                golesChart = new Chart(golesCanvas, {
                    type: 'bar',
                    data: {
    ...
    function calcularPronostico() {
        ...
        if (local === visitante) {
            alert("Equipos diferentes");
            return;
        }
        let div = document.getElementById('pronosticoResultado');
        div.innerHTML = '<p style="text-align:center">Cargando...</p>';
    ...
    function cargarCuotas() {
        ...
        fetch('/api/odds')
            ...
            .catch(e => div.innerHTML = '<p>Error al cargar cuotas</p>');
    }
    ...
    function cargarHistorial() {
        ...
        fetch('/api/historial?eq1='+encodeURIComponent(local)+'&eq2='+encodeURIComponent(visitante))
            ...
            .catch(e => div.innerHTML = '<p>Error al cargar historial</p>');
    }
